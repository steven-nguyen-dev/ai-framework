...
The **`lv1-fw-skills`** plugin provides an end-to-end gated development workflow. It replaces unstructured code generation with structured requirement analysis, confidence-graded mapping plans, strict plan gates, and cold multi-pass code audits before pull requests are created.
...
```bash
npx skills add steven-nguyen-dev/ai-framework/lv1-fw-skills/write-analysis
npx skills add steven-nguyen-dev/ai-framework/lv1-fw-skills/implementation-planner
npx skills add steven-nguyen-dev/ai-framework/lv1-fw-skills/specs-builder
npx skills add steven-nguyen-dev/ai-framework/lv1-fw-skills/review-code
```
