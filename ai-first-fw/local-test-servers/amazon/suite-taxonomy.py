#!/usr/bin/env python3
"""Amazon Marketplace Taxonomy sync suite -- the discovery calls, and the category payload (IA-5105).
...
Publishes live status to amazon/test-results/taxonomy/run-<stamp>/results.json.

Usage:
  python3 amazon/suite-taxonomy.py
  python3 amazon/suite-taxonomy.py TAX-CAT-1 TAX-CAT-2       # only the cases named
  BASE=http://127.0.0.1:23103 BASE_OMS=http://127.0.0.1:23001 python3 amazon/suite-taxonomy.py
...
SUITE = os.environ.get("SUITE", "taxonomy")
...
def publish():
    ...
    doc = {
        "name": "Amazon Marketplace Taxonomy Sync -- US vs non-US (IA-5105)",
        "suite": SUITE,
