#!/usr/bin/env python3
"""End-to-End Store Connect & Taxonomy Sync Suite — Amazon US Market (IA-5105).
...
Publishes live status to amazon/test-results/connect-us/run-<stamp>/results.json.

Usage:
  python3 amazon/suite-connect-us.py
  python3 amazon/suite-connect-us.py US-PRE-1 US-ENV-1       # only the cases named
  BASE_AMAZON=http://127.0.0.1:23103 BASE_OMS=http://127.0.0.1:23001 python3 amazon/suite-connect-us.py
"""
...
def publish():
    ...
    payload = {
        "suite": SUITE,
        "title": "Amazon US Store Connect & Taxonomy Synchronization (IA-5105)",
        "stamp": STAMP,
