...
Marketplace Taxonomy and Dynamic Product Schemas (IA-5105):
  1. Marketplace Taxonomy Sync (suite-taxonomy)
  2. US Store Connect & Taxonomy Sync (suite-connect-us)
  3. Non-US Multi-Marketplace Store Connect & Taxonomy Sync (suite-connect-non-us)
...
Usage:
  ...
  BASE=http://127.0.0.1:23103 BASE_OMS=http://127.0.0.1:23001 python3 amazon/IA-5105-US1/suite-all.py
"""
