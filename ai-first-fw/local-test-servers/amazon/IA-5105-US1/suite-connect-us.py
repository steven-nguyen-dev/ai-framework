...
requirements.py holds the expectations with their citations, and was written from the
...
Usage:
  ...
  python3 amazon/IA-5105-US1/suite-connect-us.py US-PRE-1 US-ENV-1       # only the cases named
  BASE_AMAZON=http://127.0.0.1:23103 BASE_OMS=http://127.0.0.1:23001 python3 amazon/IA-5105-US1/suite-connect-us.py
"""
...
# mock and judges what ARRIVED there. The expectations come from requirements, which was
...
# producer, not a description of code. See requirements' own header for the source list.
