...
# Amazon's captured schemas stay in amazon/schemas/, one level up from this suite folder.
SCHEMA_DIR = os.path.join(os.path.dirname(HERE), "schemas", "product-types")
