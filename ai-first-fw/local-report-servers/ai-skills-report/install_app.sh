#!/usr/bin/env bash
# ==============================================================================
# AI Skills & Plugins Registry - macOS Native Application Installer
# Installs "AI Skills & Plugins Registry.app" to /Applications (or ~/Applications)
# ==============================================================================
...
<dict>
    ...
    <string>AI Skills &amp; Plugins Registry</string>
    <key>CFBundleExecutable</key>
    <string>launcher</string>
    <key>CFBundleIconFile</key>
    <string>appIcon.icns</string>
    <key>CFBundleIdentifier</key>
    <string>com.anchanto.ai.skills.registry</string>
...
#!/bin/bash
# ==============================================================================
# AI Skills & Plugins Registry - macOS App Launcher
# ==============================================================================
...
# 1. If server is already responsive on port 24003, just focus/open the browser
if curl -s -m 1 "http://127.0.0.1:${PORT}/api/data" >/dev/null 2>&1; then
...
mkdir -p "$LOG_DIR"
LOG_FILE="$LOG_DIR/ai-skills-report.log"
...
osascript -e 'display notification "Registry server running on http://localhost:24003" with title "AI Skills & Plugins Registry" sound name "Glass"' 2>/dev/null || true
LAUNCHER
...
cp "${HERE}/scanner.py" "${APP_PATH}/Contents/Resources/app/"
cp "${HERE}/report.html" "${APP_PATH}/Contents/Resources/app/"
cp "${HERE}/ai-skills-report.html" "${APP_PATH}/Contents/Resources/app/" 2>/dev/null || true
...
echo ""
echo -e "  🌐 ${BOLD}Dashboard URL:${NC} ${SKY}http://localhost:24003${NC}"
echo -e "  📝 ${BOLD}Logs Location:${NC} ~/Library/Logs/ai-skills-report.log"
echo ""
