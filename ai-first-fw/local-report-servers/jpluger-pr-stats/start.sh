#!/usr/bin/env bash
# ==============================================================================
# JPluger PR Stats Dashboard - Launcher Script
...
# Add local bin to PATH if standalone gh was installed
...
echo -e "${BOLD}${SKY}========================================================================${NC}"
echo -e "${BOLD}${SKY}  🚀 Starting JPluger PR Stats Dashboard Server on port ${PORT}...      ${NC}"
echo -e "${BOLD}${SKY}========================================================================${NC}"
echo ""
